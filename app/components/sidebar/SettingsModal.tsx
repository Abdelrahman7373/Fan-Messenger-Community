...
const SettingsModal: React.FC<SettingsModalProps> = ({isOpen,onClose,currentUser}) => {
    ...
    const onSubmit: SubmitHandler<FieldValues> = (data) => {
        setIsLoading(true);
        axios.post('/api/settings', data).then(() => {router.refresh(); onClose();}).catch(() => toast.error('Something went wrong')).finally(() =>setIsLoading(false));
    };
        ...
        <div className="space-y-12">
            ...
            <div>
                ...
                <div className="mt-2 flex items-center gap-x-3">
                    ...
                    <CldUploadButton options={{maxFiles:1}} onUpload={handleUpload} uploadPreset="p7b8prdm">
