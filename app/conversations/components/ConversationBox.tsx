...
const ConversationBox: React.FC<ConversationBoxProps> = ({data,selected}) => {
  ...
  return (
    <div onClick={handleClick} className={clsx('w-full relative flex items-center space-x-3 hover:bg-neutral-100 rounded-lg cursor-pointer transition p-3', selected ? 'bg-neutral-100' : 'bg-white')}>
